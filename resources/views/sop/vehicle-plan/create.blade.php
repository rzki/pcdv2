...
<div class="content">
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('store_sop_vp') }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mx-auto text-center">
                                <button type="submit" class="btn btn-success confirm-create-vehicleplan"><i class="fa-solid fa-floppy-disk"></i>{{ __(' Save') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('sopVPCreateConfirm')
    <script type="text/javascript">
        $('.confirm-create-vehicleplan').click(function(event){
