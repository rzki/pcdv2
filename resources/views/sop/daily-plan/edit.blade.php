...
<div class="content">
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('update_sop_dp', $dp->id) }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row mx-auto">
                                ...
                                <div class="col-sm-7">
                                    <div class="{{ $errors->has('photo') ? ' has-danger' : '' }}">
                                        <input type="hidden" name="oldFile" value="{{ old('path',$dp->path) }}">
                            ...
                            <div class="mx-auto text-center">
                                <button type="submit" class="btn btn-success confirm-edit-dailyplan"><i class="fa-solid fa-floppy-disk"></i>{{ __(' Save') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('sopDPEditConfirm')
    <script type="text/javascript">
        $('.confirm-edit-dailyplan').click(function(event){
