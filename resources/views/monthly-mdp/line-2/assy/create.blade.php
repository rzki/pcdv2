@extends('layouts.app', ['activePage' => 'kpi', 'title' => 'Tambah Assy Line #2 - PCD', 'header' => __('Tambah Assy Line #2')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="button">
                    <a href="{{ route('monthly_2') }}" class="btn btn-primary">
                        <i class="fa fa-arrow-left"></i> Kembali
                    </a>
                </div>
                <form method="post" action="{{ route('store_assy2') }}" autocomplete="on" class="form-horizontal">
                    @csrf

                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Assy Line #2') }}</h4>
                        </div>
                        <div class="card-body">
