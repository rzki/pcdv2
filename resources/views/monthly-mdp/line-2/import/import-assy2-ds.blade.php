@extends('layouts.app', ['activePage' => 'monthly_mdp', 'title' => 'Tambah Data Assy Line #2 (Day Shift) - PCD', 'header' => __('Tambah Data Assy Line #2 (Day Shift)')])
...
<div class="content">
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('import_assy2_ds') }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Data Assy Line #2 (Day Shift)') }}</h4>
                        </div>
                        <div class="card-body">
