@extends('layouts.app', ['activePage' => 'monthly_mdp', 'title' => 'Tambah Data Volume Total MDP - PCD', 'header' => __('Tambah Data Volume Total MDP')])
...
<div class="content">
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('store_volume_total') }}" autocomplete="on" class="form-horizontal">
                    @csrf
                    <div class="card">
                        <div class="card-header card-header-success">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Data Volume Total MDP') }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-row mx-auto">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('plan') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="tgl" id="tgl" type="month" placeholder="{{ __('tgl') }}" value="{{ old('tgl', Carbon\Carbon::today()->format('m-Y')) }}" required="true" aria-required="true"/>
                                            @if ($errors->has('tgl'))
                            ...
                            <div class="form-row mx-auto">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('volume_sap') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="volume_sap" id="volume_sap" type="text" placeholder="{{ __('Volume SAP') }}" value="{{ old('volume_sap') }}" required="true" aria-required="true"/>
                            ...
                            <div class="form-row mx-auto">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('volume_kap') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="volume_kap" id="volume_kap" type="text" placeholder="{{ __('Volume KAP') }}" value="{{ old('volume_kap') }}" required="true" aria-required="true"/>
                            ...
                            <div class="form-row mx-auto">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('volume') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="volume_total" id="volume_total" type="text" placeholder="{{ __('Volume Total') }}" value="{{ old('volume_total') }}" required="true" aria-required="true"/>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                        <select class="form-select form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" aria-label="Default select example" name="status">
                                            <option value="Actual" {{ old('status') == 'Actual' ? "selected" : ""}}>Actual</option>
                                            <option value="OPR" {{ old('status') == 'OPR' ? "selected" : ""}}>OPR</option>
                                            <option value="Forecast" {{ old('status') == 'Forecast' ? "selected" : ""}}>Forecast</option>
                                        </select>
                            ...
                            <div class="mx-auto text-center">
                                <button type="submit" class="btn btn-success confirm-create">
...
@section('volumeTotalCreateConfirm')
