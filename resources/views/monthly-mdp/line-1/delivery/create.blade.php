@extends('layouts.app', ['activePage' => 'kpi', 'title' => 'Tambah Delivery Line #1 - PCD', 'header' => __('Tambah Delivery Line #1')])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{ route('store_delivery1') }}" autocomplete="on" class="form-horizontal">
                    @csrf

                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Delivery Line #1') }}</h4>
                        </div>
                        <div class="card-body">
