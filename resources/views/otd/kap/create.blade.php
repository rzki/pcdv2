@extends('layouts.app', ['activePage' => 'ontime_delivery', 'title' => 'Tambah Data OTD KAP - PCD', 'header' => __('Tambah Data OTD KAP')])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" action="{{ route('add_otd_kap') }}" autocomplete="on" class="form-horizontal">
                    @csrf

                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Data OTD KAP') }}</h4>
                        </div>
                        <div class="card-body">
