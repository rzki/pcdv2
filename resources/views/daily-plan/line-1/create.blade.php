@extends('layouts.app', ['activePage' => 'daily_prodplan_l1', 'title' => 'Tambah Data Planning Prod. Harian / Shift L#1 - PCD', 'header' => __('Tambah Data Planning Prod. Harian / Shift L#1')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <form method="post" action="{{ route('store_l1') }}" autocomplete="on" class="form-horizontal">
                    @csrf
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-center font-weight-bold">{{ __('Tambah Data Daily Production Line #1') }}</h4>
                        </div>
                        <div class="card-body">
